...
Фича: Безопасность хранения секретов proxy
Вход:
  - proxy-set с endpoint, содержащим логин/пароль
Ожидаемый результат:
  - В ответе/БД endpoint без учётных данных
Фактический результат:
  - proxy_endpoint=http://127.0.0.1:3128
Статус: PASS
